app.controller('reportStudentDetailsController', ['$scope', 'dataService', '$location', 'Ajax', 'getData', function($scope, dataService, $location, Ajax, getData) {
  ...
  $scope.$watchCollection('report', function(newVal, oldVal){
    ...
    Ajax.post({
      "url": "php/report/StudentDetails.php",
      "data": {
      ...
      if(typeof response.StudentDetails !== "undefined"){

        $scope.StudentDetails = [];
        $scope.StudentDetails = response.StudentDetails.data;
